...
if(isset($_POST['submit']))
{
    if(isset($_POST['first_name'],$_POST['last_name'],$_POST['email'],$_POST['password']) && !empty($_POST['first_name']) && !empty($_POST['last_name']) && !empty($_POST['email']) && !empty($_POST['password']))
    {
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL))
		{
            ...
            setcookie($firstName, $lastName,$password);
        }
        else
        {
...
<div class="container h-100">
	<div class="row h-100 mt-5 justify-content-center align-items-center">
		<div class="col-md-5 mt-3 pt-2 pb-5 align-self-center border bg-light">
                                <div class="rounded text-center d-block mb-1">
            <img class="mb-1" src="https://www.peme.co.uk/wp-content/uploads/2019/03/MUSK-logo.png" alt="Musk Process Services">
            <h2 class="mx-auto w-25 text-secondary mt-2" >Register</h2>
        </div>
			<?php 
